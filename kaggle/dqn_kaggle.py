...
def make_env():
    ...
    # === ATTENTION : DÉCOMMENTEZ LA LIGNE SUIVANTE POUR AIDER LE DQN ===
...
print("Début de l'apprentissage avec DQN ...")
# 500 000 étapes suffisent pour montrer la tendance (échec ou réussite)
model.learn(total_timesteps=2000000, callback=eval_callback, tb_log_name="DQN_TripleAcrobot")
