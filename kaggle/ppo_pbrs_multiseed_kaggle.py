...
RUN_NAME = "ppo_pbrs"
WORK = "/kaggle/working"
LOG_DIR = f"results_ppo_pbrs_seed{SEED}/logs/"
MODEL_DIR = f"results_ppo_pbrs_seed{SEED}/models/"
TB_DIR = f"results_ppo_pbrs_seed{SEED}/tensorboard_logs/"
...
print("Done.")
model.save(f"{MODEL_DIR}ppo_pbrs_triple_acrobot_final")


RESULTS_DIR = f"results_ppo_pbrs_seed{SEED}"
