...
RUN_NAME = "dqn_sparse"
WORK = "/kaggle/working"
LOG_DIR = f"results_dqn_sparse_seed{SEED}/logs/"
MODEL_DIR = f"results_dqn_sparse_seed{SEED}/models/"
TB_DIR = f"results_dqn_sparse_seed{SEED}/tensorboard_logs/"
...
print("Done.")
model.save(f"{MODEL_DIR}dqn_sparse_triple_acrobot_final")


# Package everything into a single zip for download.
RESULTS_DIR = f"results_dqn_sparse_seed{SEED}"
