...
SEED = 1  # CHANGE TO 2 FOR SECOND RUN
...
RUN_NAME = "ppo_sparse"
WORK = "/kaggle/working"
LOG_DIR = f"results_ppo_sparse_seed{SEED}/logs/"
MODEL_DIR = f"results_ppo_sparse_seed{SEED}/models/"
TB_DIR = f"results_ppo_sparse_seed{SEED}/tensorboard_logs/"
...
print("Done.")
model.save(f"{MODEL_DIR}ppo_sparse_triple_acrobot_final")


RESULTS_DIR = f"results_ppo_sparse_seed{SEED}"
zip_path = f"{WORK}/{RUN_NAME}_seed{SEED}_artifacts.zip"
