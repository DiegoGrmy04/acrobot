...
def make_env():
    ...
    env = TripleAcrobotRewardWrapper(env) # Application de la récompense façonnée
...
print("Début de l'apprentissage avec PPO et Reward Shaping (1 million de steps)...")
model.learn(total_timesteps=1000000, callback=eval_callback, tb_log_name="PPO_TripleAcrobot_Shaped")
print("Entraînement terminé !")

model.save("models/ppo_triple_acrobot_final")